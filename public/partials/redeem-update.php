<form enctype="multipart/form-data" method="POST" class="ezf-update-redeem-form" action="">
  ...
  <div class="modal-body">
    ...
    <div class="mb-3 check-memo">
      ...
      <label for="redeem_update_check_memo" class="form-label visually-hidden">Check Memo</label>
    ...
    <div class="mb-3">
      ...
      <input type="radio" class="btn-check" name="redeem_update_status" value="Accepted" id="redeem_update_status_accepted" autocomplete="off">
      <label class="btn btn-sm" for="redeem_update_status_accepted">Accepted</label>
      <input type="radio" class="btn-check" name="redeem_update_status" value="Declined" id="redeem_update_status_decline" autocomplete="off">
      <label class="btn btn-sm" for="redeem_update_status_decline">Declined</label>
      <input type="radio" class="btn-check" name="redeem_update_status" value="Refund" id="redeem_update_status_refund" autocomplete="off">
      <label class="btn btn-sm" for="redeem_update_status_refund">Refund</label>
    </div>
  </div>
